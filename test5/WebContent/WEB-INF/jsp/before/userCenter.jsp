				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="mo" items="${myOrder}"> 
						<tr>
							...
							<a style="text-decoration: none;" class="f6" href="<%=basePath%>myOrderDetail?ordersn=${mo.id}" target="_blank">详情</a>
							</td>
						</tr>
					</c:forEach>
				</table>
				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="mf" items="${myFocus}"> 
						<tr>
							...
							<td align="center" bgcolor="#ffffff">
								<a style="text-decoration: none;" class="f6" href="<%=basePath%>goodsDetail?id=${mf.id}">去看看</a>
							</td>
						</tr>
					</c:forEach>
				</table>
