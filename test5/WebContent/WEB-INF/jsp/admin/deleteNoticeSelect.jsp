...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<link href="test5/admin/common.css" type="text/css" rel="stylesheet">
	<style type="text/css">
		table{
			text-align: center;
	...
	<script type="text/javascript">
  		function checkDel(id){
  			if(window.confirm("是否删除该公告？")){
  				window.location.href = "/test5/adminNotice/deleteNotice?id="+id;
  			}
  		}
  </script>
</head>
		...
		<table border="1" bordercolor="PaleGreen">
			...
			<c:forEach items="${allNotices }" var="notice">
				<tr onmousemove="changeColor(this)" onmouseout="changeColor1(this)">
					...
					<td>${notice.ntitle }</td>
					<td>${notice.ntime }</td>
					<td><a href="/test5/adminNotice/selectANotice?id=${notice.id }" target="_blank">详情</a></td>
					<td>
